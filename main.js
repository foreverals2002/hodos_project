...
let mission2_description =
  "미션2 가이드:<br>초곡교회 곳곳에 붙어있는 미니임무를 찾아 수행하시오.<br> 조해창 감독관에게 임무 완료 검사를 받으면 스무고개 질문권을 받을 수 있습니다. <br> 질문권은 위수환 감독관에게 사용하십시오. <br> 스무고개 의 답이 Mission2의 암호입니다. <br> 단, 각 조마다 스무고개 답은 다르니 주의하십시오.";
let mission3_description =
  "미션3 가이드:<br>조해창 감독관을 찾아가 미션3를 받으시오.";
